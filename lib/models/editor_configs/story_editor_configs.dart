...
class StoryEditorConfigs {
  ...
  /// Creates an instance of [StoryEditorConfigs].
  /// - The `theme` specifies the theme for the Image Editor.
  /// - The `heroTag` is a unique tag for the Image Editor widget. By default, it is 'Story-Editor-Hero'.
  ...
  const StoryEditorConfigs({
    this.theme,
    this.heroTag = 'Story-Editor-Hero',
